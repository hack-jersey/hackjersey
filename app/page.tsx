      ...
      <main className="text-[#EEE] bg-y-repeat bg-[#000F16] min-h-screen relative">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <div className="w-[800px] h-[800px] bg-[#7BCDFD] rounded-full filter blur-[200px] opacity-15"></div>
          </div>
          <div className="absolute top-1/3 left-1/4 transform -translate-x-1/2 -translate-y-1/2">
            <div className="w-[600px] h-[600px] bg-[#7BCDFD] rounded-full filter blur-[150px] opacity-15"></div>
          </div>
          <div className="absolute top-2/3 right-1/4 transform translate-x-1/2 -translate-y-1/2">
            <div className="w-[700px] h-[700px] bg-[#7BCDFD] rounded-full filter blur-[180px] opacity-15"></div>
          </div>
        </div>
